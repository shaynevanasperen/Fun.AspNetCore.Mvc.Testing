...
By contributing to _Fun.AspNetCore.Mvc.Testing_, you assert that:

* The contribution is your own original work.
* You have the right to assign the copyright for the work (it is not owned by your employer, or
  you have been given copyright assignment in writing).
* You [license](https://github.com/shaynevanasperen/Fun.AspNetCore.Mvc.Testing/blob/master/LICENSE ) the contribution under the terms applied to the rest of the _Fun.AspNetCore.Mvc.Testing_ project.
* You agree to follow the [code of conduct](https://github.com/shaynevanasperen/Fun.AspNetCore.Mvc.Testing/blob/master/CODEOFCONDUCT.md).
 ...
 * Through GitHub, or through the [Gitter chat](https://gitter.im/Fun-AspNetCore-Mvc-Testing) (preferred),
   you talk about a feature you would like to see (or a bug), and why it should be in _Fun.AspNetCore.Mvc.Testing_.
 ...
 * You create, or update, a fork of `shaynevanasperen/Fun.AspNetCore.Mvc.Testing` under your GitHub account.
 ...
 * Once you feel it is ready, submit the pull request to the `shaynevanasperen/Fun.AspNetCore.Mvc.Testing` repository against the `master` branch
 ...
 * `git fetch upstream` (upstream would be the mainstream repo or `shaynevanasperen/Fun.AspNetCore.Mvc.Testing` in this case)
 * `git checkout master`
 * `git rebase upstream/master`
 * `git checkout your-branch`
 * `git rebase master`
 * Fix any merge conflicts
 * `git push origin your-branch` (origin would be your GitHub repo or `your-github-username/Fun.AspNetCore.Mvc.Testing` in this case).
...
with permission and was edited to follow _Fun.AspNetCore.Mvc.Testing_'s conventions and processes.
